...
class SalesforceModelsClient:
    ...
    def generate_text(
        ...
        **kwargs
        ...
        # BULLETPROOF: Initialize prompt_length first to prevent UnboundLocalError
        prompt_length = len(full_prompt)
        
        # Use provided timeout or calculate dynamically based on prompt size and model
        if timeout is None:
            ...
            max_timeout = 480 if os.environ.get('ENVIRONMENT') == 'production' else 300
            timeout = min(timeout, max_timeout)  # Respect maximum but allow override
