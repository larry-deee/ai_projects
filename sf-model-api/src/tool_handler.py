...
class ConversationState:
    ...
    def __init__(self):
        ...
        self.max_messages = 100 # Increased limit for better tool calling context
        self.message_cleanup_threshold = 90 # Start cleanup when approaching limit
    ...
    def add_message(self, message: ToolMessageRole):
        ...
        if len(self.messages) > self.max_messages:
            ...
            self._emergency_cleanup()  # Only run when actually exceeding limit
    ...
    def _cleanup_old_messages(self):
        ...
        recent_messages = self.messages[-30:] # Keep last 30 messages for better tool calling context
    ...
    def _emergency_cleanup(self):
        ...
        # Keep only essential messages: system + last 15 messages
        system_messages = [msg for msg in self.messages if msg.role == 'system']
        recent_messages = self.messages[-15:] # Keep last 15 messages for emergency cleanup
